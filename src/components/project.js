...
import img1 from '../components/img/ntt_data.png';
import img_triporate from '../components/img/triporate.png';
import Tappable from 'react-tappable/lib/Tappable'
import img3 from '../components/img/tesi.png';
import Aos from 'aos';
...
class Project extends Component {
    ...
    toggleCategories = () => {
        if (this.state.activeTab === 0) {
            ...
            return (
                <div className="projects-grid">
                    <Card data-aos="zoom-in" shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
